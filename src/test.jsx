  ...
  return (
    <nav className="flex items-center justify-between w-full relative">
      ...
      <ul className="items-center gap-[20px] text-[1rem] text-text lg:flex hidden">
        <li
          className={`${
            isProductHover ? "text-primary" : "text-gray-600"
      ...
      <div className="flex items-center gap-[15px]">
        ...
        <CiMenuFries
          ...
          className="text-[1.8rem] text-textc cursor-pointer lg:hidden flex"
        />
      </div>
        ...
        <ul className="items-start gap-[20px] text-[1rem] text-gray-600 flex flex-col">
          ...
          >
            ...
            <IoIosArrowDown
              ...
              } text-gray-600 group-hover:text-primary transition-all duration-300`}
            />
          </li>
          ...
          >
            ...
            >
              <li className="hover:text-primary transition-all duration-500 cursor-poin ter capitalize">
                Demo App
              </li>
              <li className="hover:text-primary transition-all duration-500 cursor-poin ter capitalize">
                CRM
          ...
          <li className="hover:text-primary transition-all duration-500 cursor-pointer capitalize">
            Support
          </li>
        </ul>
      </aside>
